<template>
  <div class="hello">
    ...
    <h1>{{ msg }}</h1>
    <button v-on:click="addPost" class="btn btn-primary">Add Post (with random contents)</button>
    <table class="table">
      <thead>
        <tr>
          <th scope="col">#</th>
...
export default {
  ...
  methods: {
    ...
    addPost: function() {
      let url = "https://my-json-server.typicode.com/classicoman2/fakeRESTserver/posts"
